  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      child: new Scaffold(
          ...
          body: Stack(
            children: <Widget>[_videoStoriesByUser(context), byUserHeader()],
          )),
      onWillPop: () async {
        Navigator.pushReplacement(
            context, MaterialPageRoute(builder: (context) => VideoStories()));
                ...
                children: <Widget>[
                  ...
                  InkWell(
                    child: videoControlAction(
                        ...
                        label: '$progress',
                        index:
                            shouldTogglePlay.contains(widget.position) ? 1 : 0),
                    onTap: () {
                      // tashi
                      downloadFile(widget.shareUrl, widget.position,
