...
class _SignInPageState extends State<SignIn> {
  ...
  Future<dynamic> errorDialog(errorMessage) async {
    try {
      print(errorMessage);
      await showDialog(
          context: context,
  ...
  void verifyPhoneNumber(String phoneNumber) async {
    ...
    try {
      ...
      final AuthCredential userCreadentialize =
      ...
      _auth.signInWithCredential(userCreadentialize).then((AuthResult user) {
        ...
        prefs.setString(
            'phoneNumber', phoneNumber); // causes chat bug if missing
        ...
        Firestore.instance
          ...
          if (newuser.exists) {
            ...
            //   });
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (context) => TermsWid()));
          }
        }).catchError((onError) {
          return errorDialog(onError);
        });
      }).catchError((onError) {
        if (mounted) {
          setState(() {
  ...
  Widget buildDefaultTitle() {
    return Container(
      child: Text('Rexa',
          style: TextStyle(
              fontSize: 30.0, color: Colors.black, fontFamily: 'Monoton')),
    );
  }
  ...
  Widget buildDefaltSubTitle() {
    return Container(
        ...
        child: Padding(
            ...
            child: Text(
              'Get Started With Your Rexa Account',
              style: TextStyle(
                fontSize: 14.0,
      ...
      children: <Widget>[
        ...
        ListTile(
          title: TextFormField(
            ...
            decoration: InputDecoration(
                labelText: 'Phone number', hintText: 'Mobile Number'),
        ...
        Align(
          child: Padding(
            ...
            padding: EdgeInsets.only(top: 20.0, left: 3.0, right: 3.0),
          ),
  ...
  Widget buildConfirmForm() {
    return Column(
      children: <Widget>[
        ...
        ListTile(
          subtitle: Text('Time remaining $times',
              style: TextStyle(color: Colors.black54, height: 1.9)),
          title: TextFormField(
        ...
        Container(
            ...
            margin: EdgeInsets.only(top: 1.9, bottom: 33)),
