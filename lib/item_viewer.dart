...
class ItemViewerState extends State<ItemViewer> {
  ...
  fetchCategories() async {
    ...
    final response = await http
        .get('https://yiiyaa-app.herokuapp.com/api/all-feeds/$_categoryType');
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Flexible(
                          fit: FlexFit.tight,
                          flex: 460,
                          child: resultsFetched[index].isVideo == true
                              ? InkWell(
                                  child: Container(
                                    color: Colors.black,
                                    child: Stack(
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) => WatchVideo(
                                                  serviceName:
                                                      resultsFetched[index]
                                                          .serviceOffered,
                                                  photoUrl:
                                                      resultsFetched[index]
                                                          .servicePhotoUrl,
                                                  isVideo: resultsFetched[index]
                                                      .isVideo,
                                                )));
                                  },
                                )
                                    ...
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) => ServicesContacts(
                                                uid:
                                                    '${resultsFetched[index].uid}',
                                                serviceOffered:
                                                    '${resultsFetched[index].serviceOffered}',
                                                userId: '$_userId',
                                                location:
                                                    '${resultsFetched[index].location}',
                                                price:
                                                    '${resultsFetched[index].price}',
                                                serviceProviderToken:
                                                    '${resultsFetched[index].serviceProviderToken}',
                                                duration:
                        ...
                        Padding(
                          padding: const EdgeInsets.only(
                              top: 1.0, left: 16.0, right: 16.0, bottom: 0.5),
                          child: Row(
                            ...
                            children: <Widget>[
                              new Row(
                                ...
                                children: <Widget>[
                                  Text(
                                      '${stringChopper(resultsFetched[index].serviceOffered)}',
                                      style: TextStyle(
                              ...
                              // HERE
                              resultsFetched[index].isVideo == true
                                  ? IconButton(
                                      icon: Icon(
