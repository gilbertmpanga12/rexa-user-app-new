            ...
            children: <Widget>[
              Center(
                ...
                padding: EdgeInsets.only(
                    top: 18.0, bottom: 1.0, left: 18.0, right: 18.0),
              )),
              Padding(
                child: Text('Share with the world',
                    style: TextStyle(
                        wordSpacing: -0.800,
                        color: Colors.white,
                                            ...
                                            child: Padding(
                                              child: snapshot
                                                  ...
                                                  ? RichText(
                                                      text: TextSpan(
                                                        text:
                                                            '${snapshot.data.documents[index]['storyTitle'].toString().length > 200 ? snapshot.data.documents[index]['storyTitle'].toString().substring(0, 200) : snapshot.data.documents[index]['storyTitle']}',
                                                        style: TextStyle(
                                                            color: Color(
                                                                0xFF484848),
                                                            letterSpacing: .2,
